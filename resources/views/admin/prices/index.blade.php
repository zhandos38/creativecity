                                ...
                                <table id="datatable" class="display compact table table-striped table-bordered table-hover">
                                    ...
                                    @forelse($prices as $v)
                                        <tr>
                                            ...
                                            <td>{{ $v->created_at }}</td>
                                            <th>
                                                {!! Form::open(['route' => ['admin.prices.destroy', $v->id], 'method' => 'post']) !!}

                                                    <a class="btn btn-warning mb-1" href="{{ route('admin.prices.show', $v->id) }}" title="Просмотр">
                                                        <i class="fa fa-eye mr-1"></i>
                                                        Просмотр
                                                    </a>

                                                    <a class="btn btn-info mb-1" href="{{ route('admin.prices.edit', $v->id) }}" title="Редактировать">
