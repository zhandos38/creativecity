                                ...
                                <table id="datatable" class="display compact table table-striped table-bordered table-hover">
                                    ...
                                    @forelse($blocks as $v)
                                        <tr>
                                            ...
                                            <td>{{ $v->created_at }}</td>
                                            <th>
                                                {!! Form::open(['route' => ['admin.blocks.destroy', $v->id], 'method' => 'post']) !!}

                                                    <a class="btn btn-warning mb-1" href="{{ route('admin.blocks.show', $v->id) }}" title="Просмотр">
                                                        <i class="fa fa-eye mr-1"></i>
                                                        Просмотр
                                                    </a>

                                                    <a class="btn btn-info mb-1" href="{{ route('admin.blocks.edit', $v->id) }}" title="Редактировать">
